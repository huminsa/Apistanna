...
class KegiatanController
{
    ...
    public function index(Request $request, Response $response)
    {
        try {
            ...
            // Siapkan query SQL
            $sql = "SELECT `id`,`kode_akun`, `kode_no_akun`, `nama_kegiatan`, `anggaran_diajukan`, `anggaran_disetujui`, `anggaran_dicairkan`, `anggaran_digunakan`, `diajukan_oleh`, `tgl_pengajuan`,
             `disetujui_oleh`, `tgl_disetujui`, `dibuat_oleh`, `tgl_dibuat` FROM `tbl_kegiatan`";
